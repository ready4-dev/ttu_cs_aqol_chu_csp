...
If you do not already have the required libraries to run this program installed, you can do so by un-commenting and running the following lines. Not if you do not already have cmdstandr installed and configured you will also need to perform a minor additional configuration step as outlined on https://mc-stan.org/cmdstanr/ .
