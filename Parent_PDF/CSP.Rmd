...
# manufacture_Ready4useDyad(projects_ls$CHU_r4@c_SpecificProject@a_YouthvarsProfile@a_Ready4useDyad, flatten_1L_lgl = T, type_1L_chr = "vars", what_1L_chr = "factors", restrict_to_chr = c("cdaysoor", "dage", "dgender")) 
```
